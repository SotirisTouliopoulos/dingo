...
- <a id="ref-2"></a> [2] King, Z. A., Lu, J., Dräger, A., Miller, P., Federowicz, S., Lerman, J. A., Ebrahim, A., Palsson, B. O., & Lewis, N. E. (2015). BiGG Models: A platform for integrating, standardizing and sharing genome-scale models. Nucleic Acids Research, 44(D1), D515–D522. https://doi.org/10.1093/nar/gkv1049
- <a id="ref-3"></a> [3] Apostolos Chalkis, Vissarion Fisikopoulos, Tsigaridas, E., & Haris Zafeiropoulos. (2024). dingo: a Python package for metabolic flux sampling. Bioinformatics Advances, 4(1). https://doi.org/10.1093/bioadv/vbae037
- <a id="ref-4"></a> [4] King, Z. A., Dräger, A., Ebrahim, A., Sonnenschein, N., Lewis, N. E., & Palsson, B. O. (2015). Escher: A Web Application for Building, Sharing, and Embedding Data-Rich Visualizations of Biological Pathways. PLoS Computational Biology, 11(8), e1004321–e1004321. https://doi.org/10.1371/journal.pcbi.1004321
